...
export function AppSidebar() {
  ...
  const expertItems = [{ title: "My Content", icon: BookOpen, path: "/expert/content" }];
  const adminItems = [
    ...
    <Sidebar>
      <SidebarHeader className="p-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="font-display text-lg font-bold text-sidebar-primary-foreground">FinBachat</h1>
            <p className="text-[10px] text-sidebar-foreground/50">Financial Literacy</p>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
